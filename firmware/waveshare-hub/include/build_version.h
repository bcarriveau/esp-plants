#pragma once
#define ESP_PLANTS_WAVESHARE_VERSION "0.2.0-alpha.13"
...
#define ESP_PLANTS_WAVESHARE_RELEASE_NOTES \
  "Disables LVGL default-theme transitions at compile time and removes the alpha.12 boot-looping runtime guard."
