...
#define ESP_PLANTS_WAVESHARE_VERSION "0.2.0-alpha.3"  // ONLY version line to change for a release
...
#define ESP_PLANTS_WAVESHARE_RELEASE_NOTES \
  "Fixes update timing and TLS memory pressure for secure GitHub checks."
