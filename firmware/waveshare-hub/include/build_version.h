...
#define ESP_PLANTS_WAVESHARE_VERSION "0.2.0-alpha.6"  // ONLY version line to change for a release
...
#define ESP_PLANTS_WAVESHARE_RELEASE_NOTES \
  "Fixes PSRAM-backed GitHub check task cleanup after secure release checks."
